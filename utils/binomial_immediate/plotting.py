...
from envs.binomial_tree_immediate_rewards import encode_wealth, encode_action, decode_action
...
def plot_q_values(Q, actions):
    ...
    plt.title("Learned action-value surface at time t={} (immediate rewards)".format(1), fontsize=20)
